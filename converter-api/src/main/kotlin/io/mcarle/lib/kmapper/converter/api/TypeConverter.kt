...
/**
 * All classes, which should be used by KMapper during KSP to identify a conversion from one to another type, have to implement this interface.
 * During KMapper startup, the [java.util.ServiceLoader] is used to collect all implementations on the classpath.
 */
interface TypeConverter {
     ...
     * Therefore, [io.mcarle.lib.kmapper.converter.StringToIntConverter] is not enabled by default.
     */
